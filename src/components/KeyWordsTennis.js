...
function KeywordsTennis() {
    function GetQuestions() {
        ...
        Axios.get("https://jservice.io/api/category?id=1147").then((r) => {
            r.data.clues.map(
                res => {
                    questions.push(res);
                }
  ...
  return (
    <div style={{display: "flex", flexDirection: "row", flex:1}}>
        <div style={{backgroundColor: "white", width: "70rem", height: "100vh"}}>
            ...
            <Link to={{pathname:'/questions', questionProps:{questions:questions}, numberOfQuestions: numberOfQuestions, sport:15, sportName:"Tennis"}} >
